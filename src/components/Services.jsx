...
const Services = () => {
  return (
    <section className="relative pt-16 md:pt-20 -mt-20 z-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-1  relative -top-8 z-10">
          ...
          <div className="relative bg-white shadow-2xl p-6 md:p-12">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-end">
              ...
              <div className="px-4 text-start">
                <h3 className="text-[#13F9DB] text-sm md:text-md font-semibold uppercase tracking-wide font-['Lato'] mb-4">
                  WELCOME TO EXPERT PAYMENT
                </h3>
